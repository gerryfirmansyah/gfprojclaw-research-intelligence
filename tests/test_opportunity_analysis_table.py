...
for x in ['ANALYSIS AWAL','Compare & Contrast','Metodologi','Unit analisis','Hasil/temuan','Mekanisme','BELUM TERVERIFIKASI','showOpportunityAnalysis(o,path,members)']: assert x in j
