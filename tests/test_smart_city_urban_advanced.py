...
for s in ['renderUrbanAdvanced','governance → lived outcomes','AI governance → urban infrastructure','context transferability','implementation mechanism','HUMAN verification required','smart-city-urban-abstracts']: assert s in j
