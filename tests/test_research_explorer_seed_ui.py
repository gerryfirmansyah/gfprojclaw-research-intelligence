...
for x in ["/seed-universe","seed_count","observed_universe_state","query_family_candidates","seed_work_ids","Scientific decision: false","Seed ≠ Universe","Discovery ≠ Evidence","NOT APPROVED","Paper pemicu:","Yang perlu HUMAN periksa:","Canonical provenance","roleLabel"]: assert x in j,x
